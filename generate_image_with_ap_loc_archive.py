...
def grid_to_image(grid, colormap="viridis", output_file=None, show_image=True, scale_factor=3, icon_path=None, icon_position=(0, 0)):
  """
...
grayscale_image = grid_to_image(grid, colormap="gray", output_file="monochrome_grid_image_ap_loc.png", icon_path="google_loc_icon_2.png", icon_position=(30, 50))

# Create the image with a custom colormap
color_image = grid_to_image(grid, colormap="plasma", output_file="plasma_grid_image_ap_loc.png", icon_path="google_loc_icon_2.png", icon_position=(50, 80))
