...
for file in grid_files :
    ...
    grayscale_image = grid_to_image(grid, colormap="gray", output_file=f'monochrome_grid_image{count}.png')

    # Create the image with a custom colormap
    color_image = grid_to_image(grid, colormap="plasma", output_file=f'plasma_grid_image{count}.png')
    count += 1
