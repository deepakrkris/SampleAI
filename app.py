...
@app.route('/GetBestLocations/<file_name>', methods=['GET'])
...
@app.route('/GetTopology/<file_name>', methods=['GET'])
...
@app.route('/mlp_predict/<file_name>', methods=['GET'])
...
@app.route('/cnn_predict/<file_name>', methods=['GET'])
...
@app.route('/mlp_topo/<file_name>', methods=['GET'])
...
@app.route('/cnn_topo/<file_name>', methods=['GET'])
